      ...
      <Router>
        <div className="PPNavbar">
          ...
          <Link to="/" className='navbar-brand'>Pretty Please</Link>
            ...
            <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul className="navbar-nav ">
                ...
                <Link to="/ForSponsors" className="nav-link">For Sponsors</Link>
                </li>
                <li className="nav-item mr-auto mt-2 mt-lg-0 nav-link">
                <Link to="/ForCharities" className="nav-link">For Charities</Link>
                </li>
                <li className="nav-item mr-auto mt-2 mt-lg-0 nav-link">
                <Link to="/NewFund" className="nav-link">New Fund Request</Link>
                </li>
              </ul>
          ...
          <Switch>
            ...
            <Route exact path='/'> <Main SponsorData={sponsor} /></Route>
            <Route  path='/ForSponsors'  component={SponsorPage}></Route>
            <Route  path='/ForCharities'><CharityPage charity={charity} /></Route>
